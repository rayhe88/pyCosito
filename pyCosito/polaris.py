...
def createCommand(node, software):
    ...
    if software == 'Espresso':
        ...
        gpu_tile = '/lus/gila/projects/catalysis_aesp_CNDA/raymundohe/bin/gpu_tile_compact.sh'
        command = 'mpiexec --hosts {} -n 12 --ppn 12 --env OMP_NUM_THREADS=1 {} {} PREFIX.nwxi > PREFIX.nwxo'.format(node,gpu_tile, binary)
#add NWChem?
    return command
